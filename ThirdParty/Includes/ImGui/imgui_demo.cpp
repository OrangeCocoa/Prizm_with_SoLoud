...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Images"))
        {
            ...
            // If you use one of the default imgui__implXXXX.cpp renderer, they all have comments at the top of their file to specify what they expect to be stored in ImTextureID.
            // (for example, the imgui__impldx11.cpp renderer expect a 'ID3D11ShaderResourceView*' pointer. The imgui__implglfw_gl3.cpp renderer expect a GLuint OpenGL texture identifier etc.)
