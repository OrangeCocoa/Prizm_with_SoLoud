...
/*
 ...
 - You may be able to grab and copy a ready made imgui__impl*** file from the examples/ folder.
 ...
 EXHIBIT 1: USING THE EXAMPLE BINDINGS (imgui__implXXX.cpp files from the examples/ folder)
     ...
     // Initialize helper Platform and Renderer bindings (here we are using imgui__implwin32 and imgui__impldx11)
 ...
 - 2015/07/08 (1.43) - switched rendering data to use indexed rendering. this is saving a fair amount of CPU/GPU and enables us to get anti-aliasing for a marginal cost.
                     ...
                     - if you are using a vanilla copy of one of the imgui__implXXXX.cpp provided in the example, you just need to update your copy and you can ignore the rest.
 ...
 A: Short explanation:
    ...
    - In the examples/ bindings, for each graphics API binding we decided on a type that is likely to be a good representation for specifying 
      an image from the end-user perspective. This is what the _examples_ rendering functions are using:
         ...
         OpenGL:     ImTextureID = GLuint                       (see ImGui_ImplGlfwGL3_RenderDrawData() function in imgui__implglfw_gl3.cpp)
         DirectX9:   ImTextureID = LPDIRECT3DTEXTURE9           (see ImGui_ImplDX9_RenderDrawData()     function in imgui__impldx9.cpp)
         DirectX11:  ImTextureID = ID3D11ShaderResourceView*    (see ImGui_ImplDX11_RenderDrawData()    function in imgui__impldx11.cpp)
         DirectX12:  ImTextureID = D3D12_GPU_DESCRIPTOR_HANDLE  (see ImGui_ImplDX12_RenderDrawData()    function in imgui__impldx12.cpp)
    ...
    Here's a simplified OpenGL example using stb_image.h:
        ...
        // Now that we have an OpenGL texture, assuming our imgui rendering function (imgui__implxxx.cpp file) takes GLuint as ImTextureID, we can display it:
