...
// IMGUI_API is used for core imgui functions, IMGUI__implAPI is used for the default bindings files (imgui__implxxx.h)
#ifndef IMGUI_API
#define IMGUI_API
#endif
#ifndef IMGUI__implAPI
#define IMGUI__implAPI              IMGUI_API
#endif
...
// Back-end capabilities flags stored in io.BackendFlags. Set by imgui__implxxx or custom back-end.
...
struct ImGuiIO
{
    ...
    ImGuiBackendFlags  BackendFlags;        // = 0                  // Set ImGuiBackendFlags_ enum. Set by imgui__implxxx files or custom back-end to communicate features supported by the back-end.
...
//  - Upload the pixels data into a texture within your graphics system (see imgui__implxxxx.cpp examples)
